import { delay, m, motion, transform, useScroll, useTransform } from "framer-motion"
    ...
    <div className={`min-h-screen transition-all duration-500 ${
     ...
     {/* Hero Section */}   
      <motion.section
        id="home"
        style={{ y: heroY }}
        className="min-h-screen flex items-center justify-center relative px-6 py-10"
        >
        ...
        <div className="max-w-7xl mx-auto w-full z-10 mt-20" >
          ...
          <div className="hidden lg:grid lg:grid-cols-2 lg:items-center lg:gap-16">
            ...
            >
              ...
              <motion.div
                ...
                <motion.button
                  ...
                  className={`border ${
                    isDarkMode ? "border-gray-600 text-gray-400 hover:bg-gray-800" : 
              ...
              <motion.div
                ...
                >
                {[
                  { icon: <FiGithub size={24} />, link: "#" },
                  { icon: <FiLinkedin size={24} />, link: "#" },
            ...
            <motion.div
              ...
              className="hidden justify-center lg:justify-end"
            > 
              <div className="relative">
                ...
                <motion.div
                  ...
                  className={`w-full h-80 rounded-2xl overflow-hidden border-4 ${
                    isDarkMode ? "border-gray-800" : "border-gray-300"}shadow-2xl`}
                >
                  <img
                    src={PROFILE_PIC}
